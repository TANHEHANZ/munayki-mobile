...
import { colaboracionesStyle, dataScrollV, loginstyle } from "../../styles/style";
    ...
    <View style={{
      ...
      >
        {Object.entries(information).map(([key,value], index)=>(
          <TouchableOpacity style={{ ...dataScrollV.div, width: 300, marginVertical: "3%", backgroundColor:getRandomColor()}} key={index} onPress={()=>Linking.openURL(value.link)}>
            <View>
